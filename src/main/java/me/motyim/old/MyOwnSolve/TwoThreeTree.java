...
public class TwoThreeTree<T extends Comparable<T>>  {
    ...
    private final int minChildrenSize = minKeySize + 1; // 2
    private final int maxKeySize = 2 * minKeySize; // 2
    private final int maxChildrenSize = maxKeySize + 1; // 3

    private Node<T> root = null;
    private int size = 0;
    private ArrayList<T> index=new ArrayList<T>();
    ...
    private static class TreePrinter {
        ...
        public static <T extends Comparable<T>> String getString(TwoThreeTree<T> tree) {
